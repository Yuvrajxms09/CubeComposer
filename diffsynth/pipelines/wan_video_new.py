...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    # Add camera control
    # Allow in-context perspective conditioning via extra tokens
    perspective_latents = kwargs.get("perspective_latents", None)
    x, (f, h, w) = dit.patchify(x, control_camera_latents_input, perspective_latents=perspective_latents)
